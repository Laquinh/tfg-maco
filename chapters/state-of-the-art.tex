...
Shor propuso un algoritmo cuántico para calcular el periodo de una función periódica de forma eficiente. Asimismo, Miller mostró que el problema de factorización se reduce a calcular el periodo de una función. Esto significa que, en un ordenador cuántico hipotético, el problema de factorización podría dejar de considerarse \textit{computacionalmente difícil} como se creía.
